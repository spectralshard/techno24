...
/* /Users/alexandrefoisy/web sites/techno24/themes/techno24/partials/produit_bitdefender/default.htm */
class __TwigTemplate_47e41243ff5f7ec277f2dc3d993952179631e9a6255fb817760d7aed486fbb90 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $filters = array("escape" => 6, "length" => 15, "raw" => 25, "page" => 30, "_" => 31);
        $functions = array();

        try {
            $this->sandbox->checkSecurity(
                ['for', 'if', 'set'],
                ['escape', 'length', 'raw', 'page', '_'],
                []
            );
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 2
            echo "<div class=\"col-xs-12 col-sm-6 col-md-6 col-lg-4 my-3 wow fadeIn\">
...
";
    ...
    {
        return "/Users/alexandrefoisy/web sites/techno24/themes/techno24/partials/produit_bitdefender/default.htm";
    }
    ...
    {
        return new Source("", "/Users/alexandrefoisy/web sites/techno24/themes/techno24/partials/produit_bitdefender/default.htm", "");
    }
}
